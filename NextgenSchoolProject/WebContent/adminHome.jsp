		...
		<div class="row">
			<div class="col-md-12 header">
				<div class="col-md-6">
					...
					<div class="col-md-6">
					<h3 style="text-align:right;">Welcome Admin Mr/Mrs.<%= session.getAttribute("adminName") %> </h3>
		...
		<div class="row">
					...
					<tbody>
						<c:forEach items="${studentList}" var="i">
							<tr>
								...
								<td> <a href="admissionForm.htm">
								<button type="button" class="btn btn-success">Get Admission</button></a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			<div class="col-md-3 Home">
				<button type="button" class="btn btn-danger pull-left"
					data-toggle="modal" data-target="#logoutAlert" ><a class="logout" href="adminLogout.htm">Logout</a></button>
				<br> <br> <a href="changePasswordView.htm"
					class="btn btn-danger pull-left">Reset Password</a><br> <br>
				<a href="enquiryForm.htm" class="btn btn-danger pull-left">Add Student</a><br><br>
				<a href="" class="btn btn-danger pull-left">Student Details</a>				
			</div>
